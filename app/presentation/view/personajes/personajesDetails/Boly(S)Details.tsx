...
export function BolyDetailsScreen({route}: any) {
            ...
            <ScrollView style={styles.principal} horizontal={false}>
                <View style={styles.adjustContainer}>
                    ...
                    <View style={styles.habilidadesContainer}>
                        ...
                        <HabilityStyle text={character?.habilidades[4]} habilitate={2}></HabilityStyle>
                        <HabilityStyle text={character?.habilidades[5]} habilitate={3}></HabilityStyle>
                    </View>
